...
- **Materi & Proyek:**
    - 🎥 [Playlist YouTube - Penjelasan Lengkap Proyek Smarthome dengan REST API](https://www.youtube.com/playlist?list=PLaC2GD6EmthX-Hn8zLGBSuZh-3k-yql-L) *(Playlist 15 video yang membahas implementasi smarthome menggunakan REST API secara detail)*
...
## 9. 🏛️ Fondasi Mikroprosesor dan Algoritma
**Deskripsi:** Memahami fondasi dasar cara kerja mikroprosesor, termasuk algoritma pemrosesan, struktur register, dan status operasi.
- **Komponen Utama:** Konsep Arsitektur Komputer, Register, Status Flag, Algoritma Dasar.
- **Repositori & Materi Belajar:**
    - 📁 [Repositori GitHub - Microprocessor Course Bank](https://github.com/Muhammad-Ikhwan-Fathulloh/Microprocessor-Course-Bank) *(Kumpulan materi perkuliahan mikroprosesor dari pertemuan 2 hingga 10)*

---

## 10. ⏱️ Real-Time Operating System (RTOS) pada ESP32
...
## 11. 🧠 Artificial Intelligence (AI) pada ESP32
...
## 12. 🤖 Robotika: Arm Robotik
**Deskripsi:** Implementasi mikrokontroler untuk sistem robotik, khususnya lengan robot (robot arm), meliputi kontrol servo, kinematika, dan aktuasi.
- **Komponen Utama:** ESP32/Arduino, Motor Servo, Driver Motor, Mekanik Lengan Robot.
- **Repositori & Proyek:**
...
- **Fitur Utama:**
    - ✅ **Kontrol penuh arah:** maju, mundur, geser kiri/kanan, berputar (rotasi).
    - ✅ **Komunikasi MQTT:** Menerima perintah melalui topik `robot/control` dan mengirim status pada topik `robot/status`.
    - ✅ **Auto Reconnect:** Koneksi WiFi dan MQTT otomatis kembali jika terputus.
    - ✅ **Beberapa Varian Kode:** Tersedia versi dengan PID, penghindar halangan (obstacle avoidance), dan kontrol lokal.
- **Koneksi Hardware:** Menggunakan dua driver L298N (masing-masing untuk 2 motor kiri dan 2 motor kanan) dengan konfigurasi pin ESP32 yang lengkap.
- **Cara Penggunaan:** Kirim perintah MQTT sederhana (`forward`, `left`, `turn_right`, dll.) dari aplikasi seperti MQTT Explorer atau IoT MQTT Dashboard.
- **Repositori & Proyek:**
    - 📁 [Repositori GitHub - KoKuBot (Mobile Robot)](https://github.com/Muhammad-Ikhwan-Fathulloh/KoKuBot) *(Berisi kode sumber untuk berbagai fitur, diagram koneksi hardware, dan dokumentasi lengkap)*
    - 🌐 [Halaman Proyek KoKuBot](https://ikhwanfathulloh.netlify.app/kokubot)

---

## 14. 🚀 Contoh Proyek Final (Implementasi Protokol)
**Deskripsi:** Kumpulan video workshop yang mendemonstrasikan implementasi akhir dari sistem IoT menggunakan berbagai protokol dan platform. Cocok sebagai referensi untuk membangun proyek tugas akhir.

- **Proyek 1: Smarthome dengan MQTT dan Website**
    - Implementasi sistem *smarthome* dimana perangkat dikendalikan dan dimonitor melalui **website** menggunakan protokol **MQTT**.
    - 🎥 [Tautan Video YouTube - Website MQTT](https://youtu.be/pf2ey2azgsc?si=VxT2zioaiF09p1jz)

- **Proyek 2: Smarthome dengan MQTT dan Kodular (Android)**
    - Implementasi sistem *smarthome* dengan antarmuka aplikasi **Android** yang dibangun menggunakan **Kodular**, terhubung melalui protokol **MQTT**.
    - 🎥 [Tautan Video YouTube - Android MQTT](https://youtu.be/_VWYaoi_2BM?si=9-vI24U7PBR_xFo3)

- **Proyek 3: Implementasi dengan Website dan REST API**
    - Implementasi sistem IoT yang berkomunikasi dengan **website** menggunakan protokol **HTTP (REST API)**.
    - 🎥 [Tautan Video YouTube - Website REST API](https://youtu.be/gKN13U-GplU?si=0ULETCDTh88RzQky)
